...
public class ExceptionHandlerGlobal {
        ...
        // falta modificar os services para lanzar esta excep personalizada cando haxa
        // un error de negocio, asi o frontEnd pode mostrar a mensaxe concreta do erro
        // (ex: stock insuficiente, cliente non existe, etc)
        @ExceptionHandler(BusinessException.class)
        public ResponseEntity<GlobalExceptionHandlerDTO> handleBusinessException(
        ...
        // Fallback genérico para cualquier otra excepción no capturada
        @ExceptionHandler(Exception.class)
        public ResponseEntity<GlobalExceptionHandlerDTO> handleGenericException(
                        Exception ex,
                        HttpServletRequest request) {
